...
Run with command:
> bash prescreening_pipeline.sh <fasta file with  references for mapping>
  <txt file with accessions> <.txt file with accessions> 
    <csv file with accessions and coordinates>
